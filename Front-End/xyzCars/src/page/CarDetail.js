...
function CarDetail() {
  ...
  return (
    ...
    >
      ...
      >
        <MdOutlineAddAPhoto /> Add Picture
      </IconButton>:""
      }
     
      </section>
      <section>
        <Card title={"My Cars"} style={{ width: "500px" }}>
          <Card
            style={{
              display: "flex",
          ...
          >
            <div style={{ display: "flex" }}>
              <h6>Bramd: </h6> {carsByCarId ? carsByCarId.brand : ""}
            </div>
            <div style={{ display: "flex" }}>
              <h6>Model: </h6> {carsByCarId ? carsByCarId.modal : ""}
            </div>
            <div style={{ display: "flex" }}>
              <h6>Year: </h6> {carsByCarId ? carsByCarId.year : ""}
            </div>
            <div style={{ display: "flex" }}>
              <h6>Plate: </h6> {carsByCarId ? carsByCarId.plate : ""}
            </div>
          </Card>
        </Card>
      </section>
